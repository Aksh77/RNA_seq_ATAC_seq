...
go_mf_upregulated = go_mf_upregulated.head(15)
plt.figure(figsize=(4,6))
sns.barplot(data=go_mf_upregulated, x='Count', y='Description', palette='viridis')
plt.ylabel('')
plt.yticks(fontsize=12)
plt.title(f'Enriched GO terms for {contrast.split("_")[0]} (Molecular Function)', pad=15)
plt.tight_layout()
...
go_bp_upregulated = go_bp_upregulated.head(15)
plt.figure(figsize=(4,6))
sns.barplot(data=go_bp_upregulated, x='Count', y='Description', palette='viridis')
plt.ylabel('')
plt.yticks(fontsize=12)
plt.title(f'Enriched GO terms for {contrast.split("_")[0]} (Biological Process)', pad=15)
plt.tight_layout()
...
go_bp_downregulated = go_bp_downregulated.head(15)
plt.figure(figsize=(4,6))
sns.barplot(data=go_bp_downregulated, x='Count', y='Description', palette='viridis')
plt.ylabel('')
plt.yticks(fontsize=12)
plt.title(f'Enriched GO terms for {contrast.split("_")[1]} (Biological Process)', pad=15)
plt.tight_layout()
