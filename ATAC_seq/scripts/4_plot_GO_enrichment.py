...
plt.title(f'Top 15 enriched GO terms for {contrast} (Molecular Function)', pad=15)
plt.tight_layout()
...
plt.ylabel('')
plt.yticks(fontsize=12)
plt.title(f'Top 15 enriched GO terms for {contrast} (Biological Process)', pad=15)
plt.tight_layout()
